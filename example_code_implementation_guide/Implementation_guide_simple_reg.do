...
* the estimated coefficients of a simple regression estimate of child income rank
* on parent income rank in each of the cells of a simulated dataset of 10,000 individuals.
